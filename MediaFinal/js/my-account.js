jQuery(function ($) {
	...
	const loggedMenuBtn = document.querySelectorAll('.menu__logged')
	const loggedMenu = document.querySelectorAll('.account__header-bar')
	loggedMenuBtn.forEach( (el, index) => {
		el.addEventListener('click', e => {
			e.preventDefault()
			loggedMenu[index].classList.toggle('visible')
		})
	});
