$(function(){
    ...
    $('.to-serf').click(function(event) {
      event.preventDefault();
      $('html, body').animate({scrollTop:$('#surf').position().top}, 1200);
      return false;
    })
    $('.to-travel').click(function(event) {
      event.preventDefault();
      $('html, body').animate({scrollTop:$('#holder').position().top}, 1200);
      return false;
    })
    $('.to-sleep').click(function(event) {
      event.preventDefault();
      $('html, body').animate({scrollTop:$('#sleep').position().top}, 1200);
      return false;
    })
    $('.to-shop').click(function(event) {
      event.preventDefault();
      $('html, body').animate({scrollTop:$('#shop').position().top}, 1200);
      return false;
    })
    $('.header__arrows a').click(function(event) {
      event.preventDefault();
      $('html, body').animate({scrollTop:$('#contact').position().top}, 1200);
      return false;
    })
});